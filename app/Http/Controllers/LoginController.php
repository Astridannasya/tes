...
class LoginController extends Controller
{
    ...
    public function loginPost(Request $request)
    {
        ...
        if ($data) {
            if (Hash::check($password,$data->password)) {                
                ...
                return redirect('login')->with('error','Nama pengguna dan Kata sandi salah');
            }
        }else{
            return redirect('login')->with('error','Nama pengguna dan Kata sandi salah');
        }
    ...
    public function registerMasyarakatPost(Request $request){
       ...
       $message = [
        'required' => 'Sudah di pakai atau kolom kosong.',
        'min' => 'sesuaikan dengan karakter',
        'max' =>'Sesuaikan dengan karakter',
       ];
        ...
        if ($saveID) {
        	...
        	if ($id) {        		
        		...
        		if (Hash::check($password,$id->password)) {
			        ...
			        if ($status) {
			        	return redirect('admin/petugas')->with('success','Kamu berhasil Register');
			        } else{
